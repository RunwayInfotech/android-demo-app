package com.avocarrot.demoapp.helpers;
...
public class DemoContent {
    ...
    // Getters
    public String getNameFor(int position) {
        return data.get(position).name;
    }

    public String getLocationFor(int position) {
        return data.get(position).location;
    }

    public String getDateFor(int position) {
        return data.get(position).date;
    }

    public String getPostFor(int position) {
        return data.get(position).post;
    }

    public String getNumberFor(int position) {
    ...
    public Drawable getSquareImageFor(int position) {
        return data.get(position).squareImage;
    }

    public Drawable getImageFor(int position) {
        return data.get(position).image;
    }

    public Drawable getIconFor(int position) {
        return data.get(position).icon;
    }
