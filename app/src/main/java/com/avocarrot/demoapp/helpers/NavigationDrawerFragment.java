...
public class NavigationDrawerFragment extends Fragment {
    ...
    class MyDrawerListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView==null) {
                ...
                convertView = layoutInflater.inflate(R.layout.fragment_navigation_drawer_row, parent, false);
                holder = new ViewHolder();
                holder.title    = (TextView) convertView.findViewById(R.id.title);
                holder.subtitle = (TextView) convertView.findViewById(R.id.subTitle);
                holder.icon     = (ImageView) convertView.findViewById(R.id.menu_icon);
                holder.stripe   = convertView.findViewById(R.id.menu_stripe);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.action_example) {
            Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://app.avocarrot.com/#/register"));
